...
const translations = {
  kk: {
    ...
    address:
      "Құрметті ағайын-туыс, бауырлар, нағашы-жиен, бөлелер, құда-жекжат, сыныптастар, көршілер мен әріптестер!",
    invitationMessage:
    ...
    venueAddress: "Темірлан елді мекені, Қажы-Мұхан 205 “Аруна” тойханасы",
    hostTitle: "Той иесі",
